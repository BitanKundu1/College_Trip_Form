...
<body>
    <img class="pg" src="pg.jpeg" alt="TINT">
    <div class="container">
        <h1>Welcome to TINT China Trip form</h3>
        <p>Enter your details and submit this form to confirm your participation in the trip</p>
       
        <?php
        if($insert == true){
        echo "<p class='submitMsg'>Thanks for submitting your form. We are happy to see you joining us for China trip</p>";
        }
        ?>
